...
- `level 01` - `./assets/level-maps/level01.json`
- `level 02` - `./assets/level-maps/level02.json`
...
Вся логика, определяющая куда "выталкивать" объект в зависимости от типа, определена в классе `src/world/colliders/raycast-collider.js`.

![RayCast collider](./img/img_005.png)
